  ...
  return (
    <div className="app-container">
      ...
      {!placingMode && !showList && (
        <div style={{ transform: navHidden ? 'translateY(200px)' : 'translateY(0)', transition: 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)', position: 'absolute', bottom: 0, left: 0, right: 0, zIndex: 1000, pointerEvents: 'none' }}>
      ...
      <ReportEditor 
        ...
        locations={acopios}
        authUser={authUser}
        onSubmit={async (content, isCritical, linkedCenterName, contactPhone, imageFile) => {
          ...
          if (imageFile) {
            const uploadedUrl = await uploadTacticalImage(imageFile);
