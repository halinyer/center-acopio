...
## 3. Arquitectura del Código (`App.tsx` y Estado)
...
3. **Gestión de Gestos:** Los eventos táctiles (como deslizar modales) se manejaban de forma nativa para evitar dependencias pesadas (`framer-motion` se descartó en el pasado para mantener el bundle ligero y el rendimiento perfecto en dispositivos lentos).
